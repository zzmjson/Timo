...
public class ExcelUtils {
     ...
     * 生成文件存放路径
     */
    public static final String FILE_PATHC = "C:\\";

    public static final String FILE_PATHD= "/excels";

    /**
     * 表格默认名称
     */
    public static final String FILE_NAME = "用户信息.xls";

    public static int formatByInt(Object obj){
        String temp = String.valueOf(obj);
        int number = Integer.valueOf(temp);
        return number;
    }
    public static String formatByProState(Object proState){
        if (proState=="1"||proState==null){
            return "未实名";
        }
        else if (proState=="1"){
            return "初级实名";
    ...
    public static String formatByUserType(Object userType){
        if (userType=="1"){
            return "普通用户";
        }
        else if (userType=="1"){
    ...
    public static int generateExcel(ExcelData excelData,String path) throws Exception {
        File folder = new File(FILE_PATHD);
...
//    }
    ...
    private static int writeTitlesToExcel(XSSFWorkbook wb, Sheet sheet, List<String> titles) {
        ...
        for (String field : titles) {
            ...
            textStyle.setDataFormat(formats.getFormat("@"));
